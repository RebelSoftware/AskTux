...
INSERT OR IGNORE INTO providers (id, name, base_url, last_model) VALUES (1, 'Ollama', 'http://localhost:11434', 'llama3.1:8b');
...
INSERT OR IGNORE INTO providers (id, name, base_url) VALUES (5, 'Google AI', 'https://generativelanguage.googleapis.com/v1beta/openai');
